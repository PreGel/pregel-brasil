<!doctype html>
  ...
  <html class="no-js"  <?php language_attributes(); ?>>
	...
	<head>
		...
		<link rel="alternate" href="https://pregelbrasil.com/" hreflang="pt-br" />
		...
		<script>
		  ...
		  ga('create', 'UA-4623260-7', 'auto', {'allowLinker': true});
		  ga('require', 'linker');
          ga('linker:autoLink', ['https://brasil.pregel-itc.com/'] );
		  ga('send', 'pageview');
